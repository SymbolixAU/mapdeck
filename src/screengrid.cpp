...
// [[Rcpp::export]]
Rcpp::List rcpp_screengrid_geojson(
	...
	std::unordered_map< std::string, std::string > screengrid_colours = mapdeck::layer_colours::no_colours;
	Rcpp::StringVector screengrid_legend = mapdeck::layer_colours::no_legend;
...
// [[Rcpp::export]]
Rcpp::List rcpp_screengrid_geojson_df(
		Rcpp::DataFrame data, Rcpp::List params,
...
// [[Rcpp::export]]
Rcpp::List rcpp_screengrid_polyline(
		Rcpp::DataFrame data, Rcpp::List params,
