...
1. src/Makevars include - relative to github install
2. ~/.R/Makevars - points to emcc compiler

```
LLVM_EMSCRIPTEN = /Users/david/Documents/github/emsdk/fastcomp/emscripten
CXX=$(LLVM_EMSCRIPTEN)/emcc
```

3. emcripten.h - changed `_IO_FILE FILE` to `_IO_FILE emFILE` to resolve a conflict
