...
In the `legend_options` argument you use a list to control the title, css and digits (number of decimal places) of the legend
...
mapdeck() %>%
	add_arc(
		...
		, legend_options = list(
			...
			stroke_to = list(title = "Destination (longitude)",  digits = 3)
