...
The colour scheme defaults to viridis. You can change it with the `palette` argument by using one of the other palettes available in `?colourvalues::colour_values`
...
Here's I'm setting all the polygons which begin with `A` as green, and the rest as red
