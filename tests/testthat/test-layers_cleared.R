...
test_that("layers are cleared", {
	...
	expect_true( layer$x$calls[[2]]$functions[[1]] == "clear_grid" )
	...
	expect_true( layer$x$calls[[2]]$functions[[1]] == "clear_line" )
	...
	expect_true( layer$x$calls[[2]]$functions[[1]] == "clear_path" )
	...
	expect_true( layer$x$calls[[2]]$functions[[1]] == "clear_pointcloud" )
	...
	expect_true( layer$x$calls[[2]]$functions[[1]] == "clear_polygon" )
	...
	expect_true( layer$x$calls[[2]]$functions[[1]] == "clear_scatterplot" )
	...
	expect_true( layer$x$calls[[2]]$functions[[1]] == "clear_screengrid" )
	...
	expect_true( layer$x$calls[[2]]$functions[[1]] == "clear_text" )
